...
## Documentation
`blueskynet` has a [pkddown](https://pkgdown.r-lib.org/index.html) website for documentation right [here](https://lassehjorthmadsen.github.io/blueskynet/reference/index.html).
