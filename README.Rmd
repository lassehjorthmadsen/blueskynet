...
The goal of blueskynet is to generate and analyze networks from Bluesky Social
...
This is the core function of blueskynet:

```{r example}
library(blueskynet)
net <- getbluenet("lassehjorthmadsen.bsky.social")
